...
return [
    ...
    */
    ...
    | AI_EVENT_COPILOT_API_KEY, falling back to the provider's key in
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Per-user limits for AI generation requests.
    |
    */

    'daily_limit' => (int) env('AI_EVENT_COPILOT_DAILY_LIMIT', 50),

    'per_minute_limit' => (int) env('AI_EVENT_COPILOT_PER_MINUTE_LIMIT', 5),
